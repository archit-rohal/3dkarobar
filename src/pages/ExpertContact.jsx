            ...
            <div className="sticky top-24">
              <div className="bg-card border border-border rounded-lg overflow-hidden shadow-soft">
                ...
                <div className="p-6">
                  ...
                  <p className="text-busybee-600 font-medium">
                  ...
                  <div className="mt-4 space-y-2">
                    <div className="flex items-start">
                      <svg
                        ...
                        className="w-5 h-5 text-busybee-500 mr-3 mt-0.5"
                      >
                      ...
                      <div>
                        ...
                        <a
                          href="tel:+43 677 61678286"
                          className="text-foreground hover:text-busybee-500"
                        >
                          +43 (677) 61678286
                        </a>
                      </div>
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <a
                          href="mailto:abhinav.shukla@3dkarobar.com"
                          className="text-foreground hover:text-busybee-500 break-all"
                        >
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <a
                          href="https://www.linkedin.com/in/abhinav-shukla-18a718135/"
                          target="_blank"
            ...
            <div className="space-y-8">
              <div>
                <h2 className="text-2xl font-semibold">
                  About Abhinav Shukla (Co-founder and Business Head)
                </h2>
                <div className="mt-4 space-y-4 text-muted-foreground">
                  ...
                  <p>
                    Leading 3D Karobar, a trusted sourcing partner for 3D
                    printing and advanced manufacturing solutions. Driving
                    business growth by leveraging deep industry expertise,
                    connecting innovative companies, and delivering seamless
                    local technical and service support through a team of highly
                    skilled engineers.
                  </p>
                  <p>
                    Accelerating LMM (Lithography based metal manufacturing)
                    technology in the additive manufacturing industry developing
                    business at Incus GmbH, based out of Vienna, Austria.
                  </p>
                  <p>
                    Enabled & developed metal powder business for INDO-MIM - a
                    world leader in metal injection molding - by generating
                    customer base in AP&C, UAE & Europe.
                  </p>
                  <p>
                    Experienced as a project lead in metal additive manufacturing
                    by handling challenging projects for various
                    applications like Medical implants, Automotive and
                    Aersopsace & defence components.
                  </p>
                </div>
              </div>

              <div className="bg-busybee-50 p-6 rounded-lg border border-busybee-100">
                <h2 className="text-xl font-semibold text-busybee-700">
                  Ready to revolutionize your manufacturing?
                </h2>
                <p className="mt-2 text-busybee-600">
                  Contact Abhinav today to schedule a consultation and discover
                  how 3Dkarobar's 3D printing solutions can transform your
                  business.
                </p>
